...
if __name__ == '__main__':
    ...
    # schedule.every().day.at("\""+ParserXML().parser()['rate_1_day']['cl_rate']+"\"").do(OpcUAClient().processPostrgres,client=OpcUAClient().connectClient(), toWhichTable=ParserXML().parser()['rate_1_day']['cl_table'])
